...
| 日付 | 種別 | 内容 |
| --- | --- | --- |
| 2026-09-26 | ![Added](https://img.shields.io/badge/Added-3fb950) | 面談日程にカレンダー表示を追加し、日付ごとの面談を確認できるようにした |
| 2026-09-26 | ![Added](https://img.shields.io/badge/Added-3fb950) | 一覧で終了済みの面談を隠せるようにした |
| 2026-09-25 | ![Changed](https://img.shields.io/badge/Changed-dfb317) | 面談日程を折りたたみ表示にし、終了済みは閉じた状態でも分かるようにした |
...
- **面談日程を一覧管理**：確定・仮予定の面談を日付順に表示し、日時やタイトルの編集、不要な予定の削除ができます。一覧では終了済みを隠せます。カレンダーでは日付ごとの面談を確認できます。
